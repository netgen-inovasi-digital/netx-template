...
class CreateCompleteNetxTemplateDatabase extends Migration
{
    public function up()
    {
        ...
        $this->forge->createTable('page_builder', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4']);
        ...
        $this->forge->addField([
            ...
            'form_fields' => [
                'type' => 'LONGTEXT',
                'null' => false,
                'comment' => 'Field form untuk section ini',
            ],
            'template_html' => [
                'type' => 'TEXT',
                'null' => false,
                'comment' => 'Template HTML untuk render',
            ],
            'preview_image' => [
                'type' => 'VARCHAR',
                'constraint' => '255',
        ...
        $this->forge->addUniqueKey('kode_template');
        $this->forge->createTable('section_templates', true, ['ENGINE' => 'InnoDB', 'CHARSET' => 'utf8mb4']);
        ...
        $this->forge->addKey('id_page', false, false, 'idx_page');
        $this->forge->addKey('id_template', false, false, 'idx_template');
        $this->forge->addKey(['status', 'urutan'], false, false, 'idx_status_urutan');
    ...
    public function down()
    {
        ...
        $this->forge->dropTable('section_templates', true);
        $this->forge->dropTable('posts', true);
        $this->forge->dropTable('pengumuman', true);
        $this->forge->dropTable('page_builder', true);
