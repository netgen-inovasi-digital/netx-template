...
class CompleteNetxTemplateSeeder extends Seeder
{
    public function run()
    {
        ...
        $this->db->table('menus')->insertBatch([
            ...
            ['id_menu' => 14, 'kode_menu' => '6.2', 'kode_induk' => '6', 'nama' => 'Layanan', 'link' => 'mitra', 'icon' => 'bi-three-dots-vertical', 'sort_order' => 8],
            ...
            ['id_menu' => 17, 'kode_menu' => '7', 'kode_induk' => '0', 'nama' => 'Urutan Tampilan', 'link' => 'layout', 'icon' => 'bi-layout-text-window', 'sort_order' => 13],
            ['id_menu' => 18, 'kode_menu' => '9', 'kode_induk' => '0', 'nama' => 'Pengaturan', 'link' => '#', 'icon' => 'bi-gear', 'sort_order' => 16],
            ['id_menu' => 19, 'kode_menu' => '9.1', 'kode_induk' => '9', 'nama' => 'Pengguna', 'link' => 'user', 'icon' => 'bi-person', 'sort_order' => 17],
            ['id_menu' => 20, 'kode_menu' => '9.3', 'kode_induk' => '9', 'nama' => 'Role', 'link' => 'role', 'icon' => 'bi-shield-lock', 'sort_order' => 19],
            ['id_menu' => 21, 'kode_menu' => '9.2', 'kode_induk' => '9', 'nama' => 'Otoritas', 'link' => 'otoritas', 'icon' => 'bi-shield-check', 'sort_order' => 18],
            ['id_menu' => 23, 'kode_menu' => '9.4', 'kode_induk' => '9', 'nama' => 'Menu ', 'link' => 'menu', 'icon' => 'bi-people', 'sort_order' => 20],
            ...
            ['id_menu' => 29, 'kode_menu' => '8', 'kode_induk' => '0', 'nama' => 'Data Master', 'link' => '#', 'icon' => 'bi bi-box', 'sort_order' => 14],
            ['id_menu' => 30, 'kode_menu' => '8.1', 'kode_induk' => '8', 'nama' => 'Motif', 'link' => 'motif', 'icon' => 'bi bi-receipt', 'sort_order' => 15],
            ['id_menu' => 31, 'kode_menu' => '5', 'kode_induk' => '0', 'nama' => 'Halaman Builder', 'link' => 'pages-builder', 'icon' => 'bi-grid', 'sort_order' => 5],
        ]);
        ...
        $this->db->table('otoritas')->insertBatch([
            ...
            ['id_otoritas' => 26, 'role_id' => 1, 'kode_menu' => '9.2', 'status_otoritas' => 1],
            ['id_otoritas' => 36, 'role_id' => 8, 'kode_menu' => '1', 'status_otoritas' => 1],
            ['id_otoritas' => 37, 'role_id' => 8, 'kode_menu' => '4', 'status_otoritas' => 1],
            ['id_otoritas' => 38, 'role_id' => 8, 'kode_menu' => '5', 'status_otoritas' => 1],
            ...
            ['id_otoritas' => 87, 'role_id' => 2, 'kode_menu' => '7', 'status_otoritas' => 1],
            ['id_otoritas' => 88, 'role_id' => 2, 'kode_menu' => '7.1', 'status_otoritas' => 1],
            ['id_otoritas' => 89, 'role_id' => 1, 'kode_menu' => '6.6', 'status_otoritas' => 1],
            ['id_otoritas' => 90, 'role_id' => 1, 'kode_menu' => '9.1', 'status_otoritas' => 1],
            ['id_otoritas' => 91, 'role_id' => 1, 'kode_menu' => '9.3', 'status_otoritas' => 1],
            ['id_otoritas' => 92, 'role_id' => 1, 'kode_menu' => '9.4', 'status_otoritas' => 1],
        ...
        // 12. Insert page_builder data (exact from SQL)
        $this->db->table('page_builder')->insertBatch([
            [
                'id_page' => 1,
                'nama_page' => 'Homepage',
                'slug' => 'homepage',
                'meta_keywords' => 'Homepage - NetX Template',
            ...
            [
                ...
                'nama_page' => 'fdffdsf',
                'slug' => 'fdffdsf',
                'meta_keywords' => 'beranda, home, rumah',
                'meta_description' => 'sasdsad',
                'status' => 'published',
                'created_at' => '2025-08-22 15:20:46',
                'updated_at' => '2025-08-26 14:24:42'
            ],
        ]);
        ...
        // 15. Insert section_templates data (exact from SQL)
        $this->db->table('section_templates')->insertBatch([
            [
                'id_template' => 1,
                'nama_template' => 'Hero Section',
                'kode_template' => 'hero',
                'deskripsi' => 'Section banner utama dengan background image',
                'icon' => 'bi-image',
                'category' => 'header',
                'form_fields' => '[{"name": "judul", "type": "text", "label": "Judul Hero", "required": true}, {"name": "deskripsi", "type": "textarea", "label": "Deskripsi", "required": true}, {"name": "background_image", "type": "file", "label": "Background Image", "accept": "image/*"}, {"name": "button_text", "type": "text", "label": "Text Button"}, {"name": "button_link", "type": "text", "label": "Link Button"}, {"name": "height", "type": "select", "label": "Tinggi Section", "options": [{"value": "400px", "text": "Normal"}, {"value": "100vh", "text": "Full Screen"}]}]',
                'template_html' => '<section class="hero-section" style="height: {{height}}; background-image: url(\'{{background_image}}\'); background-size: cover; background-position: center;">' . "\r\n" . '  <div class="hero-overlay">' . "\r\n" . '    <div class="container">' . "\r\n" . '      <h1 class="hero-title">{{judul}}</h1>' . "\r\n" . '      <p class="hero-description">{{deskripsi}}</p>' . "\r\n" . '      {{#if button_text}}<a href="{{button_link}}" class="btn btn-primary">{{button_text}}</a>{{/if}}' . "\r\n" . '    </div>' . "\r\n" . '  </div>' . "\r\n" . '</section>',
                'preview_image' => null,
                'status' => 'Y',
                'created_at' => '2025-08-22 14:16:54',
                'updated_at' => '2025-08-22 14:16:54'
            ...
            [
                'id_template' => 5,
                'nama_template' => 'Custom HTML',
                'kode_template' => 'custom_html',
                'deskripsi' => 'Section HTML custom',
                'icon' => 'bi-code-square',
                'category' => 'advanced',
                'form_fields' => '[{"name": "nama_section", "type": "text", "label": "Nama Section", "required": true}, {"name": "html_content", "type": "code", "label": "HTML Content", "required": true, "language": "html"}, {"name": "css_content", "type": "code", "label": "CSS Custom", "language": "css"}, {"name": "js_content", "type": "code", "label": "JavaScript Custom", "language": "javascript"}]',
                'template_html' => '<section class="custom-section">' . "\n" . '  {{#if css_content}}<style>{{{css_content}}}</style>{{/if}}' . "\n" . '  {{{html_content}}}' . "\n" . '  {{#if js_content}}<script>{{{js_content}}}</script>{{/if}}' . "\n" . '</section>',
                'preview_image' => null,
                'status' => 'Y',
                'created_at' => '2025-08-22 14:16:54',
                'updated_at' => '2025-08-26 14:17:07'
            ],
        ]);
        ...
        $this->db->table('layout')->insertBatch([
            ...
            [
                ...
                'kode' => 'pengumuman',
                'id_template' => null,
                'nama_section' => 'Section PENGUMUMAN',
                'html_section' => 'layout html',
